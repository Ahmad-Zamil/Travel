...
************/
  ...
  <div class="home">
    <div
      ...
      data-image-src="images/rangamati.jpg"
    ></div>
  ...
  <div class="contact_form_section" style="padding-top: 60px; margin-bottom: 50px;">
    <div class="">
      <div class="row">
          ...
          <div class="contact_form_container">
            ...
            >
              ...
              <input
                ...
                class="contact_form_contact input_field"
              ...
              <select
                id="contact_form_package"
                class="contact_form_package input_field"
                name="contact_form_package"
              >
                <option class="option" value="no_of_children">
                  Choose Your Package
                </option>
              ...
              <input
                type="date"
                id="contact_form_arrival"
                class="contact_form_arrival input_field"
                placeholder="Arrival"
                required="required"
                data-error="Arrival is required."
              />
              <input
                type="date"
                id="contact_form_departure"
                class="contact_form_departure input_field"
                placeholder="Departure"
                required="required"
                data-error="Departure is required."
              />

              <select
                id="contact_form_adults"
                class="contact_form_adults input_field"
                name="contact_form_adults"
              >
                <option class="option" value="no_of_children">
                  No of Adults
                </option>
              ...
              <select
                id="contact_form_childrens"
                class="contact_form_childrens input_field"
                name="contact_form_childrens"
              >
                <option class="option" value="no_of_children">
                  No of Children
                </option>
              ...
              <!-- <input type="text" id="contact_form_package" class="contact_form_package input_field" placeholder="Package" required="required" data-error="Package is required."> -->
